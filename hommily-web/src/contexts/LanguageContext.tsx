...
const translations = {
  zh: {
    ...
    brand: {
      ...
      values: {
        ...
        trust: '值得信赖',
        trustDesc: '日本注册商标品牌，正规渠道销售，完善的售后服务，让您购买无忧。',
      },
      promise: {
        title: '品牌承诺',
  ...
  ja: {
    ...
    brand: {
      ...
      story: {
        title: 'ブランドストーリー',
        desc1: 'Hommilyは「Home」と「Family」の組み合わせから生まれ、「温かい家庭」を意味します。日常生活に高品質な実用グッズを提供することに専念し、加湿器から晴雨兼用傘まで、すべての製品が品質生活への追求を込めています。',
        desc2: '日本登録商標ブランドとして、Hommilyは品質第一を貫いています。加湿器シリーズは超音波技術を採用し、静音でポータブル。晴雨兼用傘シリーズはUVカット100%、UPF50+の防護機能を備え、軽量で耐久性に優れています。',
        desc3: 'Hommilyのすべての製品は、丁寧な設計と厳格な品質管理を経て、お客様の日常生活により多くの便利さと快適さをお届けします。心を込めたデザイン、日常を守る。',
      },
      values: {
        title: 'コアバリュー',
        quality: '品質保証',
