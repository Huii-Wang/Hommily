...
const translations: Record<Language, any> = {
  en: {
    ...
    about: {
      ...
      intro: {
        title: 'About Us',
        desc1: 'Shenzhenshi Ecloud Technology Co., Ltd. is an innovative technology company focusing on smart home and lifestyle product R&D, design and sales. The company headquarters is located in Longgang District, Shenzhen, with a professional product R&D team and a complete supply chain system. It operates the Hommily brand, committed to providing high-quality lifestyle products for global consumers.',
