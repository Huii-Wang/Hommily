...
const translations = {
  ...
  about: {
    ...
    intro: {
      title: '公司简介',
      desc1: '深圳市易加云科技有限公司是 Hommily 品牌的运营主体，专注于高品质生活用品的研发与销售。',
      desc2: '我们秉承"用心设计，守护日常"的品牌理念，致力于为消费者提供加湿器、晴雨伞等实用生活好物。每一件产品都经过精心打磨，只为给您带来更舒适的生活体验。',
      desc3: 'Hommily 已成功注册日本商标，产品远销海内外，深受消费者信赖与喜爱。',
    },
    contact: {
      title: '联系我们',
      address: '公司地址',
