...
const translations = {
  ...
  ja: {
    ...
    brand: {
      title: 'ブランド理念',
      subtitle: '温もりを伝え、美しい生活体験を創造する',
      story: {
        title: 'ブランドストーリー',
        desc1: 'Hommilyは「Home」と「Family」の組み合わせから生まれ、「家族の家」を意味します。家は単なる居住空間ではなく、愛と温もりを運ぶ場所だと信じています。',
        desc2: '創業チームは、多くの家庭が美観を追求する一方で、実用性と快適性を見落としていることに気づきました。そこで、美学と機能のバランスを取る家具ブランドを作ることを決意しました。',
        desc3: '最初の製品から、Hommilyは「すべての家族が高品質な生活を楽しめるように」という理念を貫き、革新を続け、卓越性を追求しています。',
      },
      values: {
        title: 'コア価値',
        quality: '品質第一',
        qualityDesc: '世界中から厳選された高品質な材料を使用し、すべての生産工程を厳格に管理し、製品の耐久性を保証します。',
        design: 'デザイン革新',
        designDesc: '国際的な最先端デザイン理念と地域文化の特色を融合し、独創的な製品を創造します。',
        sustainability: '環境持続可能性',
        sustainabilityDesc: 'グリーン環境保護理念を実践し、持続可能な材料を使用し、地球と未来に責任を持ちます。',
        people: '人間中心',
        peopleDesc: 'ユーザーのニーズから出発し、心のこもったサービスを提供し、すべての家族に私たちの心遣いを感じていただきます。',
      },
      stats: {
        awards: '国際デザイン賞',
        countries: '対象国と地域',
      ...
      promise: {
        title: 'ブランドの約束',
        desc: 'すべてのお客様に高品質な製品とサービスを提供し、Hommilyをお客様が信頼する家具パートナーとし、温かく美しい家庭生活の創造に寄り添うことをお約束します。',
      },
    },
    about: {
      title: '会社概要',
